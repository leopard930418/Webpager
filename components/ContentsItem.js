...
function ContentsItem({ item, index, noColor }) {
  ...
  return (
    ...
    >
      ...
      <div
        className={
          "align-items: flex-start md:flex  justify-between " +
          (index % 2 === 0 || noColor
            ? "flex-row"
            : "flex-row-reverse bg-cover ")
        }
      >
        <div className="px-6 md:max-w-[60%] lg:max-w-[50%] xl:max-w-[40%] ">
          <h1
            className={
              index % 2 === 0 || noColor
        ...
        <div
          className={
            " align-items: flex-start object-fit: scale-down; m-auto md:m-0 max-w-[60%] md:max-w-[35%]  vertical-align: top;"
          }
        >
          <img
