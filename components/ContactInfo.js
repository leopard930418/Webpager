...
export default function ContactInfo() {
  return (
    <div
      id="section-contact"
      className="cannavigate px-6 pt-0 sm:pt-20 md:px-8 xl:px-16 my-10 sm:my-20"
    >
      <div className="flex flex-col md:flex-row justify-center items-strech m-auto w-full">
        ...
        <div className="flex justify-center bg-contact_background  dark:bg-[#151d33] dark:bg-none w-full  md:w-1/2 lg:w-1/3 h-full rounded-[20px] flex-col items-center py-10 sm:py-20">
          <img
        ...
        <div className="flex flex-col bg-gray-50 dark:bg-[#0b1124] w-full md:w-1/2 lg:w-1/3 h-full mt-0 sm:mt-10 rounded-[20px]">
          <div className="px-10">
