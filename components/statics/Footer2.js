...
function Footer2() {
  return (
    <>
      <div className="bg-[#1D1D22] h-1/2 w-full flex  md:flex-row flex-col justify-around items-center sm:items-start sm:p-20 dark:bg-slate-800">
        <div className="p-5 ">
        ...
        <div className="p-5">
          <ul>
            <p className="text-center sm:text-left  text-center sm:text-left text-white  dark:text-gray-200 font-bold text-2xl pb-4">
              Company
            </p>
            <li className="text-center sm:text-left text-gray-500  dark:text-gray-300   text-md pb-2 font-semibold hover:text-blue-600 cursor-pointer">
              Stocks
            </li>
            <li className="text-center sm:text-left text-gray-500   dark:text-gray-300  text-md pb-2 font-semibold hover:text-blue-600 cursor-pointer">
              Futures & Options
      ...
      <div className="bg-[#1D1D22] flex flex-col justify-center items-center text-center   p-5 bg-gray-50     dark:bg-slate-900 ">
        <h1 className=" text-center sm:text-left text-gray-500 dark:text-gray-200 font-semibold">
