    ...
    <div className="relative w-full bg-white dark:bg-[#0f172a] pt-12">
      ...
      <div className="flex flex-col sm:flex-row justify-center items-center w-full ">
        <div className={"flex flex-col w-full sm:w-5/12"}>
          <div className=" z-10 px-6 ">
            <label className="text-black font-semibold text-2xl  xl:text-4xl  md:text-left dark:text-gray-200">
              This is A Title
            </label>
            <p className="text-lg font-extralight  my-4	tracking-wide text-gray-800 dark:text-gray-300">
            ...
            <div className="my-4 py-4 mb-5 w-full ">
              <Button className="z-10 font-bold dark:text-gray-200 text-1xl bg-gradient-to-r from-green-500 via-blue-500 to-pink-500 rounded-3xl h-[50px] sm:w-1/3 w-1/2  ">
                CONTACT US
              </Button>
            </div>
          </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center w-full sm:w-7/12 space-y-8 sm:space-y-0 space-x-0 sm:space-x-8 px-4 sm:px-24">
          <div className="flex flex-col rounded-2xl  justify-center items-center bg-gray-50 dark:bg-[#151d33] w-full sm:w-1/2 px-8 py-20">
            <img className="w-1/3" src="assets/footer1.png" alt="" />
            <p className="text-lg text-center font-extralight  my-4	tracking-wide text-gray-800 dark:text-gray-300">
      ...
      <div className="flex  justify-center flex-col">
        <div className="flex flex-col items-center font-semibold text-center dark:text-gray-200 sm:text-4xl text-3xl pt-10">
          ...
          <p className="w-full sm:w-2/3 text-lg font-extralight  my-2	tracking-wide text-gray-800 dark:text-gray-300">
            aggagaggagLorem ipsum dolor sit amet, consectetur adipiscing elit.
            Nunc viverra porta enim quis faucibus. Etiam nisl ante, cursus et
          ...
          <div className="w-full ">
            <Button className="z-10 font-bold dark:text-gray-200 text-1xl bg-gradient-to-r from-green-500 via-blue-500 to-pink-500 rounded-3xl h-[50px] sm:m-6 sm:w-1/6 w-1/2 m-3">
              COTACT US
            </Button>
          </div>
        </div>
        <div className="relative w-full h-full flex justify-center items-center">
          <img
            ...
            className="absolute w-1/2 sm:2/3 right-0 sm:right-12 top-0 object-contain opacity-70 scale-90"
          />
          <img
            src="/assets/title.png"
            className="relative h-full w-3/4 sm:w-2/3 object-contain"
            layout="fill"
          />
        </div>
      </div>
